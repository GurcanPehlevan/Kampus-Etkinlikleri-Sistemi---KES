<?php
echo '<select style="color:black;" id="etkinlikuniversite" name="etkinlikuniversite">
<option value="bos">Üniversite Seçiniz</option>
...
<option value="İstanbul Mef Üniversitesi">İstanbul Mef Üniversitesi</option>
