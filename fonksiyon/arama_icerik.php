...
$kategori = $_GET['id'];
if($sayfa < 0){$sayfa = 0;}
$icerik_sayisi_sorgu = "SELECT e_id FROM etkinlik WHERE e_kategori_id = '$kategori'";
...
$sorgu = "SELECT * FROM etkinlik WHERE e_universite LIKE '%$terim%' OR e_etiket LIKE '%$terim%' OR e_detayliaciklama LIKE '%$terim%' ORDER BY e_id DESC";
//echo $sorgu;
