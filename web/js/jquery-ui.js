...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
		closeText: "Seç", // Display text for close link
		...
		dayNames: ["Pazar", "Pazartesi", "Ssalı", "Çarşamba", "Perşembe", "Cuma", "Cumartesi"], // For formatting
		dayNamesShort: ["Paz", "Pzt", "Sal", "Çrş", "Prş", "Cum", "Cmt"], // For formatting
	 ...
	 // yeni tarih objesi oluşturuyoruz
	this._defaults = { // Global defaults for all the date picker instances
		...
		minDate: null, // seçilebilen en erken tarihi günün tarihine ayarlıyoruz
