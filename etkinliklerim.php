...
<?php include('fonksiyon/ust.php');
	...
	<center><h2 style="margin-top:-20px;">Etkinliklerim</h2></center>
   <div class="content_middle" >
   	  <div class="container">
   	    <div class="content_middle_box">
		<?php include('fonksiyon/etkinliklerim_icerik.php'); ?>
		</br>
   		  </div>
   		  </div>
   	  </div>
	  <?php include_once('fonksiyon/etkinliklerim_syf_num.php'); ?>
   </div>
